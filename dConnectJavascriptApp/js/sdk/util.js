    ...
    ws.onmessage = function(msg) {
        ...
        if (obj.orientation) {
            ...
            if (obj.orientation.accelaration) {
                document.deviceOrientationForm.accelX.value = obj.orientation.accelaration.x;
                document.deviceOrientationForm.accelY.value = obj.orientation.accelaration.y;
                document.deviceOrientationForm.accelZ.value = obj.orientation.accelaration.z;
            }

            if (obj.orientation.accelerationIncludingGravity) {
                document.deviceOrientationForm.accelXG.value = obj.orientation.accelerationIncludingGravity.x;
                document.deviceOrientationForm.accelYG.value = obj.orientation.accelerationIncludingGravity.y;
                document.deviceOrientationForm.accelZG.value = obj.orientation.accelerationIncludingGravity.z;
            }

            if (obj.orientation.rotationRate) {
                document.deviceOrientationForm.rotationBeta.value = obj.orientation.rotationRate.beta;
                document.deviceOrientationForm.rotationGamma.value = obj.orientation.rotationRate.gamma;
                document.deviceOrientationForm.rotationAlpha.value = obj.orientation.rotationRate.alpha;
            }
