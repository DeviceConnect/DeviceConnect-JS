...
function showDeviceProximity(serviceId) {
    ...
    var str = "";
    str += "<div>";
    str += "  <input data-icon=\"search\" onclick=\"doGetDeviceProximity('" + serviceId + "')\" type=\"button\" value=\"Get\" />";
    str += "</div>";
    str += "<fieldset class=\"ui-grid-a\">";
    str += "  <div class=\"ui-block-a\">";
    str += "    <input data-icon=\"search\" onclick=\"doRegisterDeviceProximity('" + serviceId + "', '" + sessionKey + "')\" type=\"button\" value=\"Register\" />";
    str += "  </div>";
    str += "  <div class=\"ui-block-b\">";
    str += "    <input data-icon=\"search\" onclick=\"doUnregisterDeviceProximity('" + serviceId + "', '" + sessionKey + "')\" type=\"button\" value=\"Unregister\" />";
    str += "  </div>";
    str += "</fieldset>";
...
function showUserProximity(serviceId) {
    ...
    var str = "";
    str += "<div>";
    str += "  <input data-icon=\"search\" onclick=\"doGetUserProximity('" + serviceId + "')\" type=\"button\" value=\"Get\" />";
    str += "</div>";
    str += "<fieldset class=\"ui-grid-a\">";
    str += "  <div class=\"ui-block-a\">";
    str += "    <input data-icon=\"search\" onclick=\"doRegisterUserProximity('" + serviceId + "', '" + sessionKey + "')\" type=\"button\" value=\"Register\" />";
    str += "  </div>";
    str += "  <div class=\"ui-block-b\">";
    str += "    <input data-icon=\"search\" onclick=\"doUnregisterUserProximity('" + serviceId + "', '" + sessionKey + "')\" type=\"button\" value=\"Unregister\" />";
    str += "  </div>";
    str += "</fieldset>";
