...
/**
 * sdk.URIBuildeのオブジェクトを作成するテストを行う。
 * <p id="test">
...
URIBuilderTest.normalTest001 = function(assert) {
  ...
  let builder = new sdk.URIBuilder();
  assert.notEqual (builder, null, 'Create builder object.');
  done();
};
...
URIBuilderTest.normalTest002 = function(assert) {
  ...
  let profile = builder.getProfile();
  let interface = builder.getInterface();
  let attribute = builder.getAttribute();
  assert.equal (profile, 'profile', 'profile=' + profile);
  assert.equal (interface, 'interface', 'interface=' + interface);
  assert.equal (attribute, 'attribute', 'attribute=' + attribute);
  done();
};
...
URIBuilderTest.normalTest003 = function(assert) {
  ...
  assert.notEqual (uri, null, 'Create uri.');
  done();
};
 ...
 * <p id="test">
 *  Path:  /gotapi/123/123/123?123=123&accessToken=123&serviceId=123&sessionKey=123
 * </p>
 * <h3>【期待する動作】</h3>
 * <p id="expected">
 * ・URIが/gotapi/123/123/123?123=123&accessToken=123&serviceId=123&sessionKey=123であること。<br/>
 * </p>
 */
URIBuilderTest.normalTest006 = function(assert) {
  ...
  let uri = builder.build();
  assert.equal (uri, sdk.getBaseDomain() + '/gotapi/123/123/123?123=123&accessToken=123&serviceId=123&sessionKey=123',
    'uri=' + uri);
  done();
};
 ...
 * <p id="test">
 *  Path:  /gotapi/abc/abc/abc?accessToken=abc&serviceId=abc&sessionKey=abc&abc=abc
 * </p>
 * <h3>【期待する動作】</h3>
 * <p id="expected">
 * ・URIが/gotapi/abc/abc/abc?accessToken=abc&serviceId=abc&sessionKey=abc&abc=abcであること。<br/>
 * </p>
 */
URIBuilderTest.normalTest007 = function(assert) {
  ...
  let uri = builder.build();
  assert.equal (uri, sdk.getBaseDomain() + '/gotapi/abc/abc/abc?accessToken=abc&serviceId=abc&sessionKey=abc&abc=abc',
    'uri=' + uri);
  done();
};
...
URIBuilderTest.normalTest008 = function(assert) {
  ...
  let uri = builder.build();
  assert.equal (uri, sdk.getBaseDomain() + '/gotapi/%E3%81%82%E3%81%84%E3%81%86/' +
    '%E3%81%82%E3%81%84%E3%81%86/%E3%81%82%E3%81%84%E3%81%86?' +
    'accessToken=%E3%81%82%E3%81%84%E3%81%86&serviceId=%E3%81%82%E3%81%84%E3%81%86&sessionKey=%E3%81%82%E3%81%84%E3%81%86' +
    '&%E3%81%82%E3%81%84%E3%81%86=%E3%81%82%E3%81%84%E3%81%86',
    'uri=' + uri);
  done();
};
...
URIBuilderTest.normalTest009 = function(assert) {
  ...
  let uri = builder.build();
  assert.equal (uri, sdk.getBaseDomain() + '' +
    '' +
    '' +
...
QUnit.test('set limit', URIBuilderTest.normalTest009);
